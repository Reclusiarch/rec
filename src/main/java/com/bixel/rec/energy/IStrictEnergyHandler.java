...
import com.bixel.rec.math.FloatingLongTransferUtils;
...
public interface IStrictEnergyHandler {
     ...
     */
    FloatingLong insertEnergy(int container, FloatingLong amount, FluidAction action);
     ...
     */
    FloatingLong extractEnergy(int container, FloatingLong amount, FluidAction action);
     ...
     */
    default FloatingLong insertEnergy(FloatingLong amount, FluidAction action) {
     ...
     */
    default FloatingLong extractEnergy(FloatingLong amount, FluidAction action) {
