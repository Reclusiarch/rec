...
public class FloatingLongTransferUtils {
     ...
     */
    public static FloatingLong insert(FloatingLong stack, FluidAction action, IntSupplier containerCount, Int2ObjectFunction<FloatingLong> inContainerGetter, InsertFloatingLong insert) {
     ...
     */
    public static FloatingLong extract(FloatingLong amount, FluidAction action, IntSupplier containerCount, ExtractFloatingLong extract) {
        int containers = containerCount.getAsInt();
        if (containers == 1) {
    ...
    public interface InsertFloatingLong {
        ...
        FloatingLong insert(int container, FloatingLong amount, FluidAction action);
    }

    @FunctionalInterface
    public interface ExtractFloatingLong {

        FloatingLong extract(int container, FloatingLong amount, FluidAction action);
    }
}