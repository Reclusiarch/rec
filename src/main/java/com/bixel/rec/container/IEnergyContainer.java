...
import com.bixel.rec.util.AutomationType;
import com.bixel.rec.util.IContentsListener;
...
public interface IEnergyContainer extends INBTSerializable<CompoundNBT>, IContentsListener
{
    ...
    default FloatingLong insert(FloatingLong amount, FluidAction action, AutomationType automationType) 
    {
        if (amount.isZero()) 
        {
    ...
    default FloatingLong extract(FloatingLong amount, FluidAction action, AutomationType automationType) 
    {
