...
public enum RecModLang implements ILangEntry
{
    ...
    RecModLang(String type, String path) 
    {
        this(Util.makeTranslationKey(type, RecMod.loc(path)));
    }

    RecModLang(String key) 
    {
        this.key = key;
    }
    ...
    public static RecModLang get(EquipmentSlotType type) 
    {
        switch (type) {
            case HEAD:
                return HEAD;
