...
import com.bixel.rec.math.MathUtils;
import com.bixel.rec.util.helper.IHasTranslationKey;
import com.bixel.rec.util.helper.ILangEntry;
...
public class UnitDisplayUtils {//TODO: Maybe at some point improve on the ITextComponents the two getDisplay methods build, and have them have better translation keys with formats
    ...
    public enum ElectricUnit {
        JOULES(RecModLang.ENERGY_JOULES, RecModLang.ENERGY_JOULES_PLURAL, RecModLang.ENERGY_JOULES_SHORT),
        FORGE_ENERGY(RecModLang.ENERGY_FORGE, RecModLang.ENERGY_FORGE, RecModLang.ENERGY_FORGE_SHORT),
        ELECTRICAL_UNITS(RecModLang.ENERGY_EU, RecModLang.ENERGY_EU_PLURAL, RecModLang.ENERGY_EU_SHORT);
    ...
    public enum TemperatureUnit implements Unit {
        KELVIN(RecModLang.TEMPERATURE_KELVIN, "K", 0, 1),
        CELSIUS(RecModLang.TEMPERATURE_CELSIUS, "\u00B0C", 273.15, 1),
        RANKINE(RecModLang.TEMPERATURE_RANKINE, "R", 0, 1.8),
        FAHRENHEIT(RecModLang.TEMPERATURE_FAHRENHEIT, "\u00B0F", 459.67, 1.8),
        AMBIENT(RecModLang.TEMPERATURE_AMBIENT, "+STP", 300, 1);
    ...
    {
        J(RecModLang.ENERGY_JOULES_SHORT),
        FE(RecModLang.ENERGY_FORGE_SHORT),
        EU(RecModLang.ENERGY_EU_SHORT);
    ...
    {
        K(RecModLang.TEMPERATURE_KELVIN_SHORT),
        C(RecModLang.TEMPERATURE_CELSIUS_SHORT),
        R(RecModLang.TEMPERATURE_RANKINE_SHORT),
        F(RecModLang.TEMPERATURE_FAHRENHEIT_SHORT),
        STP(RecModLang.TEMPERATURE_AMBIENT_SHORT);
